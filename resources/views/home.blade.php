                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        <div class="control-group">
                                            ...
                                            <div class="modal-image col-sm-4">
                                                    <img src="data:image/png;base64,{{ $item->image }}" class="modal-image card-img-top" alt="...">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <div class="control-group">
                                            ...
                                            <div class="modal-production_aria col-sm-4">
                                                @switch($item->production_aria)
                                                    @case(1)
                                                        {{ '北海道' }}
                                                        @break
                                    ...
                                    <div class="form-group">
                                        <div class="control-group">
                                            ...
                                            <div class="modal-price col-sm-4">{{ $item->price }}</div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="control-group">
                                            <label class="col-sm-2 control-label" for="quantity">在庫数</label>
                                            <div class="modal-quantity col-sm-4">{{ $item->quantity }}</div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="control-group">
                                            <label class="col-sm-2 control-label" for="detail">商品説明</label>
                                            <div class="modal-detail col-sm-4">{{ $item->detail }}</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
